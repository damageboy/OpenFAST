...
namespace UnitTest.Template
{
    ...
    public class GroupTest : OpenFastTestCase
    {
        ...
        {
            Scalar firstName = new Scalar("First Name", FASTType.U32, Operator.COPY, ScalarValue.Undefined, true);
            Scalar lastName = new Scalar("Last Name", FASTType.U32, Operator.NONE, ScalarValue.Undefined, false);

            Group theGroup = new Group("guy", new Field[] { firstName, lastName }, false);

            byte[] actual = theGroup.Encode(new GroupValue(new Group("", new Field[] { }, false), new IFieldValue[] { new IntegerValue(1),
        ...
        public void TestDecode()
        {
            ...
            Scalar firstname = new Scalar("firstName", FASTType.U32, Operator.COPY, ScalarValue.Undefined, true);
            Scalar lastName = new Scalar("lastName", FASTType.U32, Operator.NONE, ScalarValue.Undefined, false);
            ...
            GroupValue groupValue = (GroupValue)group.Decode(inp, template, context, BitVectorReader.InfiniteTrue);
        ...
        public void TestGroupWithoutPresenceMap()
        {
            ...
            FastDecoder decoder = new FastDecoder(decodingContext, new MemoryStream(ByteUtil.ConvertBitStringToFastByteArray(encodedBits)));
        ...
        public void TestDecodeGroupWithOverlongPresenceMap()
        {
            try
            {
                ObjectMother.QuoteTemplate().Decode(new MemoryStream(ByteUtil.ConvertBitStringToFastByteArray(("00000000 10000000"))), ObjectMother.QuoteTemplate(), new Context(),
        ...
        public void TestDecodeGroupWithPresenceMapWithTooManyBits()
        {
            ...
            try
            {
                g.Decode(new MemoryStream(ByteUtil.ConvertBitStringToFastByteArray("11111000 10000001 10000000 10000110 10000000 10000110")), g, c, BitVectorReader.InfiniteTrue);
            }
            catch (FastException e)
            {
